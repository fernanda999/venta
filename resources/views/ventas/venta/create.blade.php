...
@section ('contenido')
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			{{Form::token()}}
			<a href="{{url('ventas/venta')}}" class="btn btn-outline-info btn-primary pull-right">
					...
					<div class="panel-body">
						...
						<div class ="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<table id="detalles" class="table table-striped table-bordered table-condensed table-hover">
								<thead style="background-color:#bbe3d5">
									<th>Opciones</th>
									<th>Articulos</th>
									<th>Cantidad</th>
									<th>Precio venta</th>
	...
	@push('scripts')
		<script>
			...
			function agregar()
			{
				...
				{
					alert("Error al ingresar en detalle de la venta, revise los datos del articulo");
				}
			}
